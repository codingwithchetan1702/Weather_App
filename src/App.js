...
function App() {
  ...
  return (
    <div className="min-h-screen relative bg-cover bg-center bg-[url('assets/image.jpg')]">
      {/* overlay */}
      ...
      <div className="z-50 w-full h-screen flex items-center justify-center gap-16">
        ...
        {loading && (
          <div className="mt-6 text-neutral-100">
            <div className="">
              <svg aria-hidden="true" className="w-8 h-8 text-neutral-200 animate-spin fill-red-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
